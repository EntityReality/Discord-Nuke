...
SPAM_MESSAGE = ["@everyone Nuked by RsR "]
...
Support Server:https://discord.gg/xsrWV6cKuP
https://discord.gg/rDjhXb3r5y
 J
 ''')
   await client.change_presence(activity=discord.Game(name="Call of Duty: Modern Warfare"))
...
async def NUKE(ctx):
    ...
    for ban_entry in banned_users:
      user = ban_entry.user
      try:
        await user.unban("Simon Ghost Riley#4627")
